<template>
  ...
  <div class="app-container calendar-list-container">
    ...
    <el-form :inline="true" :model="chargeForm" class="demo-form-inline">
      ...
      <el-form-item>
        <el-button type="primary" @click="open">开启作弊</el-button>
      </el-form-item>

      <el-form-item>
        <el-button type="primary" @click="close">关闭作弊</el-button>
      </el-form-item>
      <br>
    ...
    <el-table :data="tableData" width="500">
      ...
      <el-table-column align="center" prop="vip" label="作弊" width="150"></el-table-column>
...
<script>
  import {charge, getList, fetchPlayer,upGoals, downGoals,openCheat} from '@/api/player'
  ...
  export default {
    ...
    methods: {
      ...
      open(){
        openCheat(1,this.chargeForm.userId).then(response=>{
          console.log(response);
          this.onSearch()
          this.$message({
            message: '修改成功',
      ...
      close(){
        openCheat(0,this.chargeForm.userId).then(response=>{
          console.log(response);
          this.onSearch()
          this.$message({
            message: '修改成功',
